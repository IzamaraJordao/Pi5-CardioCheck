...
class Approved extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    SizedBox(height: 20),
              Text(
                'Negativo para potencial doenças no coração!',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 24,
      ...
      Padding(
                ...
                child: Image.asset(
                  'assets/images/img_sem_doenca.png',
                  width: 200,
                  height: 200,
                ),
              ),
              ...
              SizedBox(height: 10),
              Text(
                'Lembre-se sempre de realizar check-ups regulares com profissionais de saúde para a detecção precoce de possíveis problemas cardíacos. Cuidar da saúde do coração é fundamental para promover uma vida longa e saudável!',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 18,
